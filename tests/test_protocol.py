...
def test_construct_state_change(protocol):
    assert protocol.construct_state_change(cmd_prefix, 1) == bytearray(
        [0xBB, 0x0F, 0x69, 0x52, 0x00, 0x41, 0x06, 0x01]
    )
    assert protocol.construct_state_change(cmd_prefix, 0) == bytearray(
        [0xBB, 0x0F, 0x69, 0x52, 0x00, 0x41, 0x06, 0x00]
    )
...
def test_construct_effect_start(protocol):
    assert protocol.construct_effect_start(cmd_prefix, 0) == bytearray(
        [0xBB, 0x0F, 0x69, 0x52, 0xC0, 0x01, 0x01, 0x00]
    )
    assert protocol.construct_effect_start(cmd_prefix, 5) == bytearray(
        [0xBB, 0x0F, 0x69, 0x52, 0xC0, 0x01, 0x01, 0x05]
    )
